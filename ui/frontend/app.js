...
function updateDimensionInfo() {
  ...
  const dimension = selectedOption.getAttribute("data-dim");
  
  // Update status to show dimension info
  if (dimension) {
    statusEl.textContent = `Selected model will generate ${dimension}D vectors`;
  }
}
