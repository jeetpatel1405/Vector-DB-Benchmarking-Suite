...
def get_embedding_file_for_model(model_name: str) -> str:
    """Get the appropriate embedding file based on model dimensions"""
    if model_name.startswith("openai:"):
        if "ada-002" in model_name:
            return "data/embeddings_1536d_ada.parquet"
        elif "3-small" in model_name:
            return "data/embeddings_1536d_3small.parquet"
        elif "3-large" in model_name:
            return "data/embeddings_3072d_3large.parquet"
    elif "all-MiniLM-L6-v2" in model_name:
        return "data/embeddings_384d.parquet"
    elif "all-mpnet-base-v2" in model_name:
        return "data/embeddings_768d.parquet"
    elif "all-distilroberta-v1" in model_name:
        return "data/embeddings_768d_distil.parquet"
    
    # Default fallback
    return "data/embeddings.parquet"
